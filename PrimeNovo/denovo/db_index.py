...
class DB_Index:
    ...
    '''
    def __init__(self, db_path, filenames=None, ms_level = 2, valid_charge = None, annotated = True, lock = True, map_size: int = 1073741824):
        '''
    ...
    def _init_db(self):
        if self.lock == True:
            ...
            read = True
        self.env = lmdb.open(str(self.db_path), map_size=self.map_size, subdir=False, readonly = read, lock=self.lock)
